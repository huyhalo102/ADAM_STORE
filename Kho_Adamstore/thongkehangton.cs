...
namespace Kho_Adamstore
{
    public partial class thongkehangton : Form
    {
        ...
        public void load()
        {
            string query = "select MaHang,TenHang,MaLoai,SoLuong,sum(SoLuong* DonGia) as thanhtien from Hang  group by MaHang,TenHang,MaLoai,SoLuong";//vi su dung split cat theo khoang trang suy ra viet phaii cach dau phay,
            ...
            dtgrvthongke.Columns[1].Width = 150;
            dtgrvthongke.Columns[2].HeaderText = "Loại Hàng";
            dtgrvthongke.Columns[2].Width = 50;
            dtgrvthongke.Columns[3].HeaderText = "hàng tồn";
            dtgrvthongke.Columns[3].Width = 50;
            dtgrvthongke.Columns[4].HeaderText = "Thành tiền";
            dtgrvthongke.Columns[4].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
        }
